 ...
 * (see `docs/agent-prompts/skills/README.md`). The DB row is the source of
 * truth at run time; editing a body here only affects freshly seeded workspaces.
 */

export const TEST_QUALITY_RUBRIC = `# Test Quality Rubric
