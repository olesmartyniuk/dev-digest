/* PR Detail — /repos/:repoId/pulls/:number. F2 shell extended by A2 with:
   ...
   Tab state lives in query (?tab). Data/URL orchestration lives in
   `_hooks/usePrDetail`; this file is layout. */
"use client";
...
import { usePrDetail } from "./_hooks/usePrDetail";
